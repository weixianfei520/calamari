...
class LunSerializer(ValidatingSerializer):
    class Meta:
        fields = ('lun', 'iqn', 'name', 'size', 'image', 'pool', 'device_type', 'bs_type', 'write_cache')
        create_allowed = ('lun', 'iqn', 'name', 'size', 'image', 'pool', 'device_type', 'bs_type', 'write_cache')
        create_required = ('iqn', 'name', 'size', 'image')
        modify_allowed = ('name', 'size')
        modify_required = ()

    lun = serializers.IntegerField(required=False, min_value=1, max_value=255)
    iqn = serializers.CharField(required=False)
    name = serializers.CharField(required=False)
    size = serializers.IntegerField(required=False, min_value=1, max_value=4096)
    image = serializers.CharField(required=False)
    pool = serializers.CharField(required=False)
    bs_type = serializers.CharField(required=False)
    device_type = serializers.CharField(required=False)
    write_cache = serializers.CharField(required=False)


class TargetSerializer(ValidatingSerializer):
    class Meta:
        fields = ('id', 'iqn', 'incomingdiscoveryuser', 'outgoingdiscoveryuser')
        create_allowed = ('iqn', 'incomingdiscoveryuser', 'outgoingdiscoveryuser')
        create_required = ('iqn',)
        modify_allowed = ('iqn',)
        modify_required = ('iqn',)
    ...
    # initiator_addr_list = serializers.CharField(required=False)
    # initiator_name_list = serializers.CharField(required=False)
    # incominguser_list = serializers.CharField(required=False)
    # outgoinguser_list = serializers.CharField(required=False)
    incomingdiscoveryuser = serializers.CharField(required=False)
    outgoingdiscoveryuser = serializers.CharField(required=False)

class RadgwSerializer(ValidatingSerializer):
    class Meta:
        fields =('ip','type','host','keyring','rgw')
        create_allowed = ('host','keyring','rgw_socket_path','rgw_frontends','rgw_dns_name')
        create_required =('host','rgw','rgw_frontends','rgw_dns_name')
        modify_allowed = ('host','rgw','rgw_frontends','rgw_dns_name')
        modify_required = ('host')
...
# class CloneSerializer(ValidatingSerializer):
#     class Meta:
#         fields = ('clone','name','size','image','device_type','bs_type','write_cache')
#         create_allowed = ('clone','name','size','image','pool','device_type','bs_type','write_cache')
#         create_required = ( 'name', 'size', 'image')
#         modify_allowed = ('name', 'size')
#         modify_required = ()
#     clone = serializers.IntegerField(required=False, min_value=1, max_value=255)
#     #su iqn = serializers.CharField(required=False)
#     name = serializers.CharField(required=False)
#     size = serializers.IntegerField(required=False, min_value=1, max_value=4096)
#     image = serializers.CharField(required=False)
#     pool = serializers.CharField(required=False)
